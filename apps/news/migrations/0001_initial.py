    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', models.SlugField(blank=True, help_text='URL для поиска тэга по его наименованию', max_length=100, unique=True, verbose_name='Url')),
            ],
            options={
                'verbose_name': 'Тэг',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('author', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='published_news', to=settings.AUTH_USER_MODEL, verbose_name='Автор новости')),
                ...
                ('group', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='group_news', to='groups.group', verbose_name='Создано группой')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('datetime_updated', models.DateTimeField(auto_now=True, verbose_name='время обновления')),
                ('datetime_deleted', models.DateTimeField(blank=True, null=True, verbose_name='время удаления')),
                ('content', models.TextField(help_text='Контент вашего комментария', verbose_name='Контент')),
                ('commentator', models.ForeignKey(help_text='Тот, кто оставил комментарий', on_delete=django.db.models.deletion.CASCADE, related_name='comments', to=settings.AUTH_USER_MODEL, verbose_name='Владелец комментария')),
                ...
                ('news', models.ForeignKey(help_text='Комментриуем какую новость', on_delete=django.db.models.deletion.CASCADE, related_name='comments', to='news.news', verbose_name='Новость')),
            ],
            options={
