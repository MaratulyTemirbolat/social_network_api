    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('commentator', models.ForeignKey(help_text='Тот, кто оставил комментарий', on_delete=django.db.models.deletion.RESTRICT, related_name='comments', to=settings.AUTH_USER_MODEL, verbose_name='Владелец комментария')),
                ...
                ('news', models.ForeignKey(help_text='Комментриуем какую новость', on_delete=django.db.models.deletion.RESTRICT, related_name='comments', to='news.news', verbose_name='Новость')),
            ],
            options={
