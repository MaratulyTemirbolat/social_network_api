    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('news', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='n_complains', to='news.news', verbose_name='Новость')),
                ('owner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='complains', to=settings.AUTH_USER_MODEL, verbose_name='Владелец жалобы')),
                ('reason', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='complains', to='complains.complainreason', verbose_name='Причина жалобы')),
            ],
            options={
