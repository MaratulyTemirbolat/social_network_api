    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('video', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, to='videos.video', verbose_name='Видео')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='video',
            name='owner',
            field=models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, related_name='owned_videos', to=settings.AUTH_USER_MODEL, verbose_name='Владелец'),
        ),
