    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('performers', models.ManyToManyField(related_name='performer_songs', to='music.performer', verbose_name='Исполнители')),
                ('playlist', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='playlist_songs', to='music.playlist', verbose_name='Плэйлист')),
                ('users', models.ManyToManyField(blank=True, related_name='user_songs', to=settings.AUTH_USER_MODEL, verbose_name='Слушатели')),
            ],
            options={
                'verbose_name': 'Музыка',
